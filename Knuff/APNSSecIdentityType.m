...
NSArray<NSString *> * APNSSecIdentityGetTopics(SecIdentityRef identity) {
  ...
  if ((values[APNSSecIdentityTypeDevelopmentCustomExtension] && values[APNSSecIdentityTypeProductionCustomExtension]) || values[APNSSecIdentityTypeDevelopmentCustomExtension]) {
